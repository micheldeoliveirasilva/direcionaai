            ...
            VStack(alignment: .leading) {
                ...
                HStack {
                    ...
                    Text(task.subject.subjectName)
                        ...
                        .fontWeight(.light)
                        .padding(5)
                        .background(task.subjectColor.color.opacity(0.6))
                        .cornerRadius(6)
...
#Preview {
    ...
    let task = UserTask(taskName: "Fazer lista", priority: .low, subject: subject, dateLimit: .now, notes: "", progress: "", status: .done, subjectColor: .rosa)
